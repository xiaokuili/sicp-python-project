...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    "*** YOUR CODE HERE ***"
    if num_rolls == 0:
        return max([int(a) for a in str(opponent_score)]) + 1
...
def select_dice(score, opponent_score):
    ...
    if int(score) + int(opponent_score) == 0:
        return four_sided
    if (int(score) + int(opponent_score)) % 7 == 0:
        return four_sided
    return six_sided
...
def play(strategy0, strategy1, goal=GOAL_SCORE):
    ...
    while score < 100 and opponent_score < 100:
        ...
        rolls = take_turn(num_rolls, opponent_score, dice)
       
        score =  score + rolls
        # print("who: ", who, ",score: ", score-rolls, ",opponent_score:", opponent_score, ",score add ", rolls, "= ", score)
       
        if score != 0 and opponent_score != 0:
            if score / opponent_score == 2.0 or opponent_score / score == 2.0:
                score, opponent_score = opponent_score, score
                # print("swine swap", "who: ", who, ",score: ", score, ",opponent_score", opponent_score)
        who = other(who)
        score, opponent_score = opponent_score, score
...
def swap_strategy(score, opponent_score):
    ...
    """
    "*** YOUR CODE HERE ***"
    rolls = take_turn(0, opponent_score)
    if opponent_score / (rolls + score) == 2.0:
        return 0
    if  (rolls + score)/opponent_score == 2.0:
        return BASELINE_NUM_ROLLS
